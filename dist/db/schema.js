import { pgTable, serial, varchar, timestamp, integer, decimal, text, date, pgEnum, boolean, jsonb, } from 'drizzle-orm/pg-core';
...
export const users = pgTable('users', {
    ...
    role: varchar('role', { length: 50 }).notNull().default('Agent').$type(),
